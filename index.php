...
//查询角色信息
if (!empty($serverid) && !empty($roleid) && !empty($money)) {
									...
									<div class="pay-info">
										<div class="form">
											<div class="form-group">
												...
												<div class="col-sm-9">
													<input class="form-control" id="serverlist" name="serverlist" type="text" maxlength="30" placeholder="区服名称" value="<?php echo $serverid; ?>" <?php if(!empty($serverid)) echo "readonly" ?> />
												</div>
											</div>
											<div class="form-group">
												<label for="nickName" class="control-label col-sm-3">昵称<span class="red-txt"> *</span></label>
												<div class="col-sm-9">
													<input class="form-control" id="nickName" name="nickName" maxlength="20" type="text" placeholder="请输入您的昵称" value="<?php echo $username; ?>" <?php if(!empty($username)) echo "readonly" ?> />
												</div>
											</div>
											...
											<div class="form-group" id="custom-input">
												...
												<div class="col-sm-9">
													<input class="form-control" id="money" name="money" oninput="toMoney()" type="text" maxlength="20" placeholder="请确认您的支付金额(支持小数点后2位)" value="<?php echo $money; ?>" <?php if(!empty($money)) echo "readonly" ?> />
												</div>
											</div>
											<div class="form-group">
							...
							<div>
								<div class="box-inner">
									<div>
										...
										<em><span>¥</span><em id="realMoney" name="realMoney"><?php echo $money; ?></em></em>
